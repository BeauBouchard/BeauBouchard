...
function init_table() {
  ...
  for (let i = 0; i < 7; i++) {
      ...
      switch (i) {
          case 1: cell.innerHTML = '<span class="ghCalendarLabelLeft">Mon</span>'; break;
          case 3: cell.innerHTML = '<span class="ghCalendarLabelLeft">Wed</span>'; break;
          case 5: cell.innerHTML = '<span class="ghCalendarLabelLeft">Fri</span>'; break;
      };
  };
